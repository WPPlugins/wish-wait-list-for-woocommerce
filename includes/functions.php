...
if( ! function_exists( 'br_wish_list_general_callback' ) ) {
    /**
     * Function for general settings callback
     *
     * @return void
     */
    function br_wish_list_general_callback() { 
        include Wish_List_TEMPLATE_PATH . "general_settings.php";
    }
}

if( ! function_exists( 'br_wish_list_style_callback' ) ) {
    /**
     * Function for style settings callback
     *
     * @return void
     */
    function br_wish_list_style_callback() { 
        include Wish_List_TEMPLATE_PATH . "style_settings.php";
    }
}

if( ! function_exists( 'br_wish_list_text_callback' ) ) {
    /**
     * Function for text settings callback
     *
     * @return void
     */
    function br_wish_list_text_callback() { 
        include Wish_List_TEMPLATE_PATH . "text_settings.php";
    }
}

if( ! function_exists( 'br_wish_list_javascript_callback' ) ) {
    /**
     * Function for javascript settings callback
     *
     * @return void
     */
    function br_wish_list_javascript_callback() { 
        include Wish_List_TEMPLATE_PATH . "javascript_settings.php";
    }
}

if( ! function_exists( 'br_wish_list_license_callback' ) ) {
    /**
     * Function for license settings callback
     *
     * @return void
     */
    function br_wish_list_license_callback() { 
        include Wish_List_TEMPLATE_PATH . "license_settings.php";
    }
}
...
if ( ! function_exists( 'berocket_font_select_upload' ) ) {
    ...
    function berocket_font_select_upload( $text, $id, $name, $value, $show_fa = true, $show_upload = true, $show_remove = true, $data_sc = '' ) {
        ...
        if ( $show_fa ) {
            $result .= '<input type="button" class="berocket_aapf_font_awesome_icon_select button" value="'.__('Font awesome', 'BeRocket_Wish_List_domain').'"/>
        ...
        if ( $show_upload ) {
            $result .= '<input type="button" class="berocket_aapf_upload_icon button" value="'.__('Upload', 'BeRocket_Wish_List_domain').'"/> ';
        }
        if ( $show_remove ) {
            $result .= '<input type="button" class="berocket_aapf_remove_icon button" value="'.__('Remove', 'BeRocket_Wish_List_domain').'"/>';
        }
        $result .= '</div>';
...
function generate_ww_list ( $terms ) {
    foreach ( $terms as $term ) {
        echo '<li class="berocket_ww_product" data-id="'.$term['id'].'">';
        echo '<a class="berocket_ww_remove" href="#remove"><i class="fa fa-times"></i></a>';
        echo '<a href="'.$term['link'].'"><h3 class="berocket_ww_title">'.$term['title'].'</h3>';
        echo $term['image'].'</a>';
        $class_stock = '';
        $text_stock = '';
        ...
        echo apply_filters( 'berocket_wish_in_stock_status', $text_stock, $term['is_in_stock'] );
        echo '<p class="berocket_ww_price price">'.$term['price'].'</p>';
        echo '</li>';
    }
}
